...
#5 
Story.create({text: "You get to the coffee pot and discover you forgot to start the auto-brew. It'll take at least 10 minutes to brew. What do you do?", option_1: "If it's going to take 10 minutes, you might as well stop at Starbucks on the way to City Hall." , option_2: "Cast Fireball on the coffee pot. It has failed you for the last time." , option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 12, option_2_link_id: 48})

#6 
Story.create({text: "You get to the coffee pot and discover you forgot to start the auto-brew. It'll take at least 10 minutes to brew. What do you do?", option_1: "If it's going to take 10 minutes, you might as well stop at Starbucks on the way to City Hall.", option_2: "Smash the coffee pot with your mace. You never could get the damned thing to work anyway. Then you can hit the road and go grab Starbucks.", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 49, option_2_link_id: 11})
...
#29 
Story.create({text: "You blast the pump with a fireball. What were you thinking? You're not sure. But you definitely think 'I'm and idiot.' just before the explosion obliterates you.", option_1: "Forget this stupid game", option_2: "Insert .25 to try again.", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 46, option_2_link_id: 45})
