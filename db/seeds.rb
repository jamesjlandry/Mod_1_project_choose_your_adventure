...
#4 
Story.create({text: "You smash your phone with your mace. A shattered piece of the screen cuts a deep groove into your face. What do you do?", option_1: "Nothing, you/'re a warrior, scars are awesome.", option_2: "Grab some Neosporin, and a band-aid, no sense in risking infection, you've got a city to save.", option_1_link_id: 9, option_2_link_id: 10})

#5 
Story.create({text: "You get to the coffee pot and discover you forgot to start the auto-brew. It/'ll take at least 10 minutes to brew. What do you do?", option_1: "If it/'s going to take 10 minutes, you might as well stop at Starbucks on the way to City Hall." , option_2: "Cast Fireball on the coffee pot. It has failed you for the last time." , option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 12, option_2_link_id: 12})

#6 
Story.create({text: "You get to the coffee pot and discover you forgot to start the auto-brew. It/'ll take at least 10 minutes to brew. What do you do?", option_1: "If it/'s going to take 10 minutes, you might as well stop at Starbucks on the way to City Hall.", option_2: "Smash the coffee pot with your mace. You never could get the damned thing to work anyway. Then you can hit the road and go grab Starbucks.", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 11, option_2_link_id: 11})
...
#12 
Story.create({text: "You pull out of the driveway and wind your way through your sub-division when you realize your gas light is on. Getting downtown from here is at least an hour at this time of day.", option_1: "Stop at the nearest gas station. You don't have to top it off, just get enough in the tank to get you there.", option_2: "Just go for it. You/'re pretty sure the gas light just came on, you would have noticed before now, right? You should have a good 30 miles left before you run out. The faster you get there the more lives you save.", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 14, option_2_link_id: 16})

#13 
Story.create({text: "You/'re one stop away from the on-ramp when an old lady walks steps out into the road in front of you. Hunched over a walker, she looks up and raises her thumb indicating she wants a ride.", option_1: "You don't have time for this, gun it and run her over. She/'s clearly causing more harm slowing you down. You/'ve got people to save.", option_2:  "Stop and offer her a ride. You are a hero after all.", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 17, option_2_link_id: 21})
...
#19 
Story.create({text: "You pull out your mace and start to sneak up on your ex, but they turn around before you can attack. Your ex is a formidable villian and casts lightning bolt at you. You are incenerated on the spot.", option_1: "Forget this stupid game", option_2: "Insert .25 to continue", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 46, option_2_link_id: 45})
...
#34 
Story.create({text: "You hop out to change the tire. You/'re not really the tire changing type, but you just needed to get out of there. As you pull on the tire iron, your grip slips and you topple backward into traffic. The last thing you see before you die is the grill of a Ford Mustang and a big black tire inches from your head. You hate Mustangs. What a crappy way to die.", option_1: "Forget this stupid game", option_2: "Insert .25 to continue", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 46, option_2_link_id: 45})
...
#37 
Story.create({text: "You stand your ground and prepare to attack again, but this creep is fast. You don/'t even feel it before everything goes black. You died.", option_1: "Forget this stupid game", option_2: "Insert .25 to continue", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 46, option_2_link_id: 45})
...
#43 
Story.create({text: "The old lady/'s face turns red with anger. Before you can say anything, she transforms into a giant ogre, grabbing you in one large hand and throws you into the road. The last thing you see before you die is the grill of a Ford Mustang and a big black tire inches from your head. You hate Mustangs. What a crappy way to die.", option_1: "Forget this stupid game", option_2: "Insert .25 to continue", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 46, option_2_link_id: 45})

#44 
Story.create({text: "Looking around, you notice one particular sap who you/'re sure you can talk out of a fiver or two. The again, you did give the old lady a ride over here. She owes you doesn/'t she?", option_1: "Tell the old lady she owes you five bucks for the ride. What choice does she have if she wants to get the rest of the way home anyway?", option_2: "Ask the sucker. He/'s a sure bet and you doubt the old lady has any cash anyway.", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 43, option_2_link_id: 32 })
