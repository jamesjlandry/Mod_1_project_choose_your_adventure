...
#4 
Story.create({text: "You smash your phone with your mace. A shattered piece of the screen cuts a deep groove into your face. What do you do?", option_1: "Nothing, you/'re a warrior, scars are awesome.", option_2: "Grab some Neosporin, and a band-aid, no sense in risking infection, you've got a city to save.", option_1_link_id: 4, option_2_link_id: 6})

#5 
Story.create({text: "You get to the coffee pot and discover you forgot to start the auto-brew. It/'ll take at least 10 minutes to brew. What do you do?", option_1: "If it/'s going to take 10 minutes, you might as well stop at Starbucks on the way to City Hall." , option_2: "Cast Fireball on the coffee pot. It has failed you for the last time." , option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe." , option_1_link_id: 11, option_2_link_id: 12})

#6 
Story.create({text: "You get to the coffee pot and discover you forgot to start the auto-brew. It/'ll take at least 10 minutes to brew. What do you do?", option_1: "If it/'s going to take 10 minutes, you might as well stop at Starbucks on the way to City Hall.", option_2: "Smash the coffee pot with your mace. You never could get the damned thing to work anyway. Then you can hit the road and go grab Starbucks.", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe." , option_1_link_id: 11, option_2_link_id: 13})
...
#19 
Story.create({text: "You pull out your mace and start to sneak up on your ex, but they turn around before you can attack. Your ex is a formidable villian and casts lightning bolt at you. You are incenerated on the spot." })
...
#28 
Story.create({text: "You take your mace to the pump. After about 5 minutes of wailing away at it the gas stars flowing. Unfortunately for you, your next strike causes a spark. You are blasted across to the other side of the highway, and quickly into death."})

#29 
Story.create({text: "You blast the pump with a fireball. What were you thinking? You/'re not sure. But you definitely think /'I/'m and idiot/.' just before the explosion obliterates you."})
...
#37 
Story.create({text: "You stand your ground and prepare to attack again, but this creep is fast. You don/'t even feel it before everything goes black. You died."})
...
#43 
Story.create({text: "The old lady/'s face turns red with anger. Before you can say anything, she transforms into a giant ogre, grabbing you in one large hand and throws you into the road. The last thing you see before you die is the grill of a Ford Mustang and a big black tire inches from your head. You hate Mustangs. What a crappy way to die." })
