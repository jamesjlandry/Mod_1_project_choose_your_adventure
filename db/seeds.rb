...
#4 
Story.create({text: "You smash your phone with your mace. A shattered piece of the screen cuts a deep groove into your face. What do you do?", option_1: "Nothing, you're a warrior, scars are awesome.", option_2: "Grab some Neosporin, and a band-aid, no sense in risking infection, you've got a city to save.", option_3: "Honestly, why did you start this adventure to begin with. Quit and come back later, … maybe.", option_1_link_id: 9, option_2_link_id: 10})
